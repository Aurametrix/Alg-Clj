...
;; There are six regular expression functions starting with re- in clojure.core:
...
;; #"f.nd" can be also used directly
...
;; classic example regexes from myregexp.com/examples.html and learningclojure.com
